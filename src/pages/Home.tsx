            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <img 
                    src="/images/espace-de-travail-a-ecran-vide-avec-ordinateur-portable-sur-la-table-la-nuit-espace-de-copie.webpjpg"
                ...
                <div className="space-y-4 mt-8">
                  ...
                  />
                  <img 
                    src="/images/espace_travail_bureau.webp"
